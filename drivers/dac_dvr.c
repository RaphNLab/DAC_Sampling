...
void dma_setup(void)
{
	...
	dma_set_peripheral_address(DMA1, DMA_CHANNEL2, (uint32_t)DAC_16BIT_DATA_REG);
	dma_set_memory_address(DMA1, DMA_CHANNEL2, (uint32_t)sine_wave);
	dma_set_number_of_data(DMA1, DMA_CHANNEL2, 32);
